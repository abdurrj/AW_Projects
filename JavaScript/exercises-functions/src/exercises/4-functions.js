...
testCase('Functions', {
  ...
  'Hoisting': function() {
    ...
    function firstGetSquare(num) {        // defined as function, everything gets hoisted
      return num * num;
    }

    var secondGetSquare = function (num) { // not defined as function, will not be hoisted
      return num * num;
    }
  ...
  'Variadic function (2) (bonus)': function() {
     ...
     */
    function combine(operator, ...args) {
