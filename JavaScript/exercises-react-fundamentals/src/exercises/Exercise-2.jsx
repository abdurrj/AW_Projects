...
// const MyFirstComponentWithClasses = REPLACE_ME;

class MyFirstComponentWithClasses extends React.Component{
  render(){
    return (
...
const MySecondComponentWithInlineStyles = class extends React.Component{
  divStyle = {padding: "20px", border: "1px solid black"}
  pStyle = {backgroundColor: "green", color: "brown"}
  render(){
    return(
      <div style={this.divStyle}>
        <p style={this.pStyle}>Hello World!</p>
      </div>
    )
  }
};
...
const MyFirstComponentWithInlineStylesAndClasses = class extends React.Component{
  ...
  render(){
    return (
      <div className="awesome-container" style={this.divStyle}>
        <p className="awesome-paragraph" style={this.pStyle}>Hello World!</p>
      </div>
    )
  }
};
