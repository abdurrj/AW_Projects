...
# Hvilket kontinent har flest land og hvor mange land er det?
...
*/
select co.name, coalesce(ci.name, 'Ingen hovedstad'), 100*ci.population/co.population PercentOfTotPop
from country co
...
# Hvor mange land er det som starter på q, r, s, t, og u.
select (select count(name) from country where name between 'Q%' and 'U%')
as 'antall land som starter på q, r, s, t eller u';

# Hva er de tre største uoffisielle språkene i Russland?
